...
let attachmentProcessEnabled = true;
...
const executorInstallControl = document.getElementById('executor-install-control');
const executorInstallBtn = document.getElementById('executor-install-btn');
const executorInstallMenu = document.getElementById('executor-install-menu');
const executorInstallRunBtns = document.querySelectorAll('.executor-install-run-btn');
const executorInstallDeleteBtns = document.querySelectorAll('.executor-install-delete-btn');
const executorInstallCopyBtns = document.querySelectorAll('.executor-install-copy-btn');
const executorInstallStatusBadges = document.querySelectorAll('[data-install-status]');
...
const attachmentProcessToggle = document.getElementById('attachment-process-toggle');
